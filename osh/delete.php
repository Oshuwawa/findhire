...
<body>
	<h1>Are you sure you want to reject this application?</h1>
	...
	<div class="container" style="border-style: solid; border-color: red; background-color: #ffcbd1;height: 500px;">
		...
		<div class="deleteBtn" style="float: right; margin-right: 10px;">
			<form action="core/handleForms.php?id=<?php echo $_GET['id']; ?>" method="POST">
				<input type="submit" name="deleteUserBtn" value="REJECT" style="background-color: #f69697; border-style: solid;">
			</form>			
		</div>	
